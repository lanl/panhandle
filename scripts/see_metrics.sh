...
# now display results
echo "CPU Message:"
grep -m5 "cpu" tmp_metrics.txt
echo ""

echo "GPU Message:"
grep -m5 "gpu" tmp_metrics.txt
echo ""

echo "Memory Message:"
grep -m5 "mem" tmp_metrics.txt
echo ""

echo "Memory Fault Message:"
grep -m5 "fault" tmp_metrics.txt
echo ""

echo "Socket Message:"
grep -m5 "sock" tmp_metrics.txt
echo ""

echo "I/O Message:"
grep -m5 "Read_Count" tmp_metrics.txt
echo ""
